...
public class PipeSpawner : MonoBehaviour
{
	...
	[SerializeField] private float sizeMin = 1;
	[SerializeField] private float sizeMax = 1.2f;
    ...
    void SpawnPipe()
    {
		Vector3 randomSize = new Vector3 (Random.Range (sizeMin, sizeMax),1,1);
		
		pipeUp.transform.localScale = randomSize;
		
		pipeDown.transform.localScale = randomSize;
	...
	void RandomsizePipe()
	{
		Vector3 randomSize = new Vector3 (Random.Range (sizeMin, sizeMax),Random.Range (sizeMin, sizeMax),1);
